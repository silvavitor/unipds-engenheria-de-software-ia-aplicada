...
- 👥 **Two User Roles**:
  - `vitor` (admin) - Can access file system tools
  - `julia` (member) - Cannot access file system tools
...
```bash
npm run chat -- --user julia --unsafe
```
